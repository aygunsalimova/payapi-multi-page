...
function HomeBottom(props) {
    return (
        <div id='home-bottom' className='py-156 px-165 bg-main-color-3'>
            <div className="absolute w-780 h-780 bg-circle opacity-25 top-1665 right-m385 rounded-780"></div>

            <div className="flex flex-row justify-between items-center mt-36 mb-36">
                <div className="part-3">
                    <h1 className='text-circle font-dm-serif text-5xl leading-56 tracking-m369 h-16 overflow-y-hidden'>Simple UI & UX</h1>
                    <p className='text-main-color-4 font-public-sans text-base leading-7 flex flex-col justify-center items-start gap-6'>Our pre-built form is easy to integrate in your app or website’s checkout flow and designed to optimize conversion. </p>
                </div>
            ...
            <div id='home-bottom-2' className='flex flex-row gap-8 justify-between'>
                <div className='w-350'>
